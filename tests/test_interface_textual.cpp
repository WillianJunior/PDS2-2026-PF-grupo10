...
TEST_CASE("Testes de Unidade - Classe InterfaceTextual") {
    ...
    SUBCASE("Métodos de Renderização e Utilidades Visuais") {
        // Garante que chamadas de saída de tela e limpeza de buffer rodem de forma estável
        interface.limparTela();
        interface.exibirMensagem("Teste de Feedback do Sistema");
        interface.exibirComodos();
        ...
        interface.exibirAlerta(listaAlertasFalsos);
    }
