...
public:
     ...
     *  Inicializa o dispositivo de áudio com um ID gerado automaticamente.
    ...
    /** @brief Altera o nível de volume atual do dispositivo.
     *  @param int Valor inteiro representando o volume desejado. */
