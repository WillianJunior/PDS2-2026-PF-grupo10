...
struct Node {
    ...
    string acao;                 /**< Ação a ser executada no dispositivo (Valores esperados: "ligar", "desligar", "abrir", "fechar" e "ajustar") */
 ...
 * @details
 * A classe Macro permite agrupar múltiplas ações sobre diferentes dispositivos.
...
class Macro{
    ...
    public:
    static int qtdMacros; /**< Quantidade total de macros criadas */
     ...
     * @details
     * Cria um novo nó contendo o dispositivo identificado pelo id informado
     * e a ação a ser executada. O nó é inserido ao final da lista encadeada.
     * A obtenção do ponteiro para o dispositivo a partir do id deve ser feita
     * por outro componente do sistema (classe Casa).
     ...
     * @details
     * Remove o nó da lista encadeada que corresponde ao dispositivo com o id
     * informado e à ação especificada. Caso existam múltiplos nós iguais,
     * apenas o primeiro encontrado é removido.
     * @param id Identificador do dispositivo.
